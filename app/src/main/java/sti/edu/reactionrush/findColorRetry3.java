...
public class findColorRetry3 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(backPressed == 2){
            startActivity(new Intent(findColorRetry3.this, Menu.class));
        }else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_color_retry3);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btn5.setBackgroundColor(getResources().getColor(R.color.yellow));
                        btn6.setBackgroundColor(getResources().getColor(R.color.cyan));
                        btn7.setBackgroundColor(getResources().getColor(R.color.brown));
                        btn8.setBackgroundColor(getResources().getColor(R.color.green));
                        startGame.setBackgroundColor(getResources().getColor(R.color.magenta));
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry3.this, findColorRetry4.class));
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry3.this, findColor3.class));
            }
        });
    }
}
...
public class findColor2 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if (backPressed == 2) {
            startActivity(new Intent(findColor2.this, Menu.class));
        } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_color2);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btn2.setBackgroundColor(getResources().getColor(R.color.brown));
                        btn3.setBackgroundColor(getResources().getColor(R.color.black));
                        btn4.setBackgroundColor(getResources().getColor(R.color.yellow));
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColor2.this, findColorRetry3.class));
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColor2.this, findColor3.class));
            }
        });
    }
}
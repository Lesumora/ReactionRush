...
public class findColor3 extends AppCompatActivity {

    RelativeLayout border;
    long startTime, endTime, currentTime, second, bestTime = 100000;
    Button startBtn, startGame, next, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8;
    ...
    public void onBackPressed() {
        ...
        if (backPressed == 2) {
            startActivity(new Intent(findColor3.this, Menu.class));
        } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_color3);
        border = (RelativeLayout) findViewById(R.id.relativeLayout);

        SharedPreferences prefs = this.getSharedPreferences("ReactionRush", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("Best Time", save);
        editor.commit();
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btn3.setBackgroundColor(getResources().getColor(R.color.magenta));
                        btn4.setBackgroundColor(getResources().getColor(R.color.brown));
                        btn5.setBackgroundColor(getResources().getColor(R.color.black));
                        btn6.setBackgroundColor(getResources().getColor(R.color.yellow));
                        btn7.setBackgroundColor(getResources().getColor(R.color.blue));
                        btn8.setBackgroundColor(getResources().getColor(R.color.green));
                        startGame.setBackgroundColor(getResources().getColor(R.color.red));

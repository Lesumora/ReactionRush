...
public class findColorRetry extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(backPressed == 2){
            startActivity(new Intent(findColorRetry.this, Menu.class));
        }else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_color_retry);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btn1.setBackgroundColor(getResources().getColor(R.color.magenta));
                        ...
                        btn6.setBackgroundColor(getResources().getColor(R.color.brown));
                        btn7.setBackgroundColor(getResources().getColor(R.color.black));
                        btn8.setBackgroundColor(getResources().getColor(R.color.yellow));
                        startGame.setBackgroundColor(getResources().getColor(R.color.green));
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry.this, findColorRetry2.class));
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry.this, findColor2.class));
            }
        });
    }
}
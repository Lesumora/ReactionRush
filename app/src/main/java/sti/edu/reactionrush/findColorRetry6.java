...
public class findColorRetry6 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(backPressed == 2){
            startActivity(new Intent(findColorRetry6.this, Menu.class));
        }else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_color_retry6);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btn7.setBackgroundColor(getResources().getColor(R.color.magenta));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry6.this, findColor3.class));
            }
        });
    }
}
...
public class findColorRetry2 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(backPressed == 2){
            startActivity(new Intent(findColorRetry2.this, Menu.class));
        }else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_color_retry2);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btn1.setBackgroundColor(getResources().getColor(R.color.brown));
                        ...
                        btn5.setBackgroundColor(getResources().getColor(R.color.magenta));
                        ...
                        startGame.setBackgroundColor(getResources().getColor(R.color.yellow));
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry2.this, findColor.class));
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry2.this, findColor2.class));
            }
        });
    }
}
...
public class findColorRetry5 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(backPressed == 2){
            startActivity(new Intent(findColorRetry5.this, Menu.class));
        }else{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_color_retry5);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btn1.setBackgroundColor(getResources().getColor(R.color.yellow));
                        btn2.setBackgroundColor(getResources().getColor(R.color.magenta));
                        ...
                        startGame.setBackgroundColor(getResources().getColor(R.color.brown));
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry5.this, findColorRetry6.class));
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColorRetry5.this, findColor3.class));
            }
        });
    }
}
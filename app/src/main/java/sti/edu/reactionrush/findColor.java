...
public class findColor extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if (backPressed == 2) {
            startActivity(new Intent(findColor.this, Menu.class));
        } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btn1.setBackgroundColor(getResources().getColor(R.color.cyan));
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(findColor.this, findColorRetry.class));
            }
        });
